      ...
      <Card sx={{ padding: '16px', borderRadius: '14px' }}>
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
            <Typography
              gutterBottom
              sx={{ color: '#424242', fontSize: 30, fontWeight: 800, marginTop: '3px' }}
            >
          ...
          <div>
            <Typography sx={{ color: '#616161' }}>{props.cardContent.description}</Typography>
          </div>
          <div
            style={{
              width: '100%',
          ...
          <div style={{ width: '100%' }}>
            <Accordion>
              ...
              <AccordionDetails>{precautionList}</AccordionDetails>
            </Accordion>
          </div>
        </CardContent>
      </Card>
