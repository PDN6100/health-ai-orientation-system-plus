    ...
    return (
      <div
        style={{
          ...
          height: '100vh',
          background:
            'linear-gradient(135deg, #fefaff, #fefaff, #fbf9ff, #e5fcff, #d7fffc, #d6fff6, #d6fff6, #d9fff7, #e6fff9, #f7fffd, #feffff, #ffffff)',
        }}
      >
        <img src="/assets/on-my-way-snoopy.gif" alt="Loading..." style={{ height: '200px' }} />
        <p style={{ marginTop: '10px', fontSize: '25px', color: '#555' }}>
          Doctor Snoopy is coming...
        </p>
      </div>
    );
  }
          ...
          <Grid container spacing={6}>
            <Grid item xs={12} style={{ textAlign: 'center' }}>
              <div className="title">
                ...
                >
                  Predict diseases based on symptoms and get personalized health insights
                </p>
                <Button
                  variant="contained"
                  ...
                  style={{
                    ...
                    padding: '10px 23px',
                    fontSize: '12px',
                    background: 'linear-gradient(135deg,#00b6d6 0%,#0adaff 100%)',
                    fontWeight: '500',
                  }}
                  className="btn"
                  onClick={() => {
            ...
            <Grid item xs={12} sm={6} md={4}>
              <div className="card">
                ...
                <p>
                  Advanced AI-powered system to predict potential diseases based on your symptoms
                </p>
              </div>
            </Grid>
            <Grid item xs={12} sm={6} md={4}>
